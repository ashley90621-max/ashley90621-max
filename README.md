...
I work at the intersection of machine learning, financial analytics, and product development.
My focus is on building end-to-end data-driven systems, especially in domains where
prediction, risk, and timing matter.

With a background in finance and a transition into ML-driven analytics, I approach problems
not just as modeling exercises, but as complete solutions — from data pipeline to product.

- Building **credit risk & loan timing prediction models** @ Amplifi Capital
- Developing **RAG-based industry report generation assistant** systems using LLM APIs
...
* Dissertation: Loan Timing Prediction using ML × Fintech *
* In collaboration with [Amplifi Capital UK](https://www.amplificapital.com/) *
